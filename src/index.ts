...
function envAllowedUserIds(): number[] | undefined {
...
function envAllowAllUsers(): boolean | undefined {
 ...
 */
export async function apply(ctx: Context, config: TelegramConfig): Promise<void> {
